...
def build_depth_preview_fragment(preview, summary):
  ...
  <div class="text-small text-muted">
    Road-aligned local axes: +Z is above the road and -Z is pothole/down. Hover coordinates remain original input XYZ.
  </div>
</div>
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Optional small red PLY cube marker centered at the deepest point.",
    )
...
def apply_default_output_paths(args):
    ...
    if args.deepest_marker is None:
        args.deepest_marker = output_dir / f"{stem}_deepest_point_marker.ply"
