...
set "DATASET=C:\neuralangelo\datasets\20260625_nonsmooth_ds10"
set "IMAGE_PATH=%DATASET%\images_raw"
set "SPARSE_MODEL=%DATASET%\sparse\1"
set "OUTPUT_ROOT=C:\neuralangelo\output_colmap"
set "MAX_IMAGE_SIZE=1600"
set "RUN_NAME=nonsmooth_ds10_%MAX_IMAGE_SIZE%"
...
echo This is the most RAM-intensive step and can take a long time.
